...
`define		BOOT_IT_ADDR	32'h0000//指令存储器基地址
`define		IT_RAM_DEPTH	17'h10000	//指令存储器深度
`define		IT_RAM_WIDTH	4'h8	//指令存储器宽度
//指令和数据存储分别使用两套存储空间
`define		BOOT_DATA_ADDR	32'h0000//数据存储器基地址
`define		DATA_RAM_DEPTH	17'h10000	//数据存储器深度
`define		DATA_RAM_WIDTH	4'h8		//数据存储器宽度
//串口分频计数器
`define     UART_COUNT      5208
`define     UART_COUNT_HALF 2604    
...
//STORE指令标识符
`define		NO_STORE		4'b0000
`define		STORE_B			4'b0001
`define		STORE_H			4'b0011
`define		STORE_W			4'b1111
